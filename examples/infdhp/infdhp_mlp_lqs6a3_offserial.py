...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="INFDHP")
    ...
    parser.add_argument("--value_func_name", type=str, default="Costate")
    ...
    alg.set_parameters({"gamma": 0.99, "tau": 1, "forward_step": 30, "equilibrium": [0, 0, 0, 0, 0, 0]})
