...
if __name__ == "__main__":
    ...
    parser.add_argument("--discrete_mode", type=str, default="backward_discrete")
    parser.add_argument("--algorithm", type=str, default="INFGDHP")
    parser.add_argument("--enable_cuda", default=False, help="Enable CUDA")
    parser.add_argument("--seed", default=0, help="Disable CUDA")
    ...
    parser.add_argument("--value_func_name", type=str, default="StateValueNCostate")
    ...
    alg.set_parameters({"gamma": 0.99, "tau": 1, "forward_step": 30, "weight_loss_v": 0.2, "adapt_weights": False, "weights_saturate_iter": 15000, "equilibrium": [0, 0, 0, 0, 0, 0]})
