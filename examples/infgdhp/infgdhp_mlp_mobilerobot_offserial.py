...
if __name__ == "__main__":
    ...
    parser.add_argument("--algorithm", type=str, default="INFGDHP", help="RL algorithm")
    ...
    alg = create_alg(**args)
    alg.set_parameters({"reward_scale": 1, "gamma": 0.99, "tau": 1, "forward_step": 10, "weight_loss_v": 0.2})
